...
export class HotelService{
    ...
    getHotels(){
        return this.httpClient.get("http://localhost:5156/api/Hotel");
       }
    ...
    addHotel(hotel:Hotel){
        ...
        return this.httpClient.post("http://localhost:5156/api/Hotel",hotel,requestOptions);
    }
    ...
    updateHotel(hotel:Update){
        ...
        console.log(hotel);
        const requestOptions = {headers:header};
        return this.httpClient.put("http://localhost:5156/api/Hotel/Update",hotel,requestOptions);
    }
}