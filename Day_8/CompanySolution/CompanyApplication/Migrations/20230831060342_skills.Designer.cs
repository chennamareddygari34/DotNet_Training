...
namespace CompanyApplication.Migrations
{
    ...
    [Migration("20230831060342_skills")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeSkill", b =>
                {
                    ...
                    b.Property<string>("SkillsSkillName")
                        .HasColumnType("text");

                    b.HasKey("EmployeesId", "SkillsSkillName");

                    b.HasIndex("SkillsSkillName");
            ...
            modelBuilder.Entity("EmployeeSkill", b =>
                {
                    b.HasOne("CompanyApplication.Models.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CompanyApplication.Models.Skill", null)
                        .WithMany()
                        .HasForeignKey("SkillsSkillName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
