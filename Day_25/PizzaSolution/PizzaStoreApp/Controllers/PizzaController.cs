...
namespace PizzaStoreApp.Controllers
{
    public class PizzaController : Controller
    {
        ...
        {
            new PizzaWithPic{Id=1,Name="Schezwan Margherita", Price=389,Quantity=3,Type="Non-Veg",Pic="/images/Pizza1.JPG"},
            new PizzaWithPic{Id=2,Name="Ultimate Tandoori Veggie", Price=609,Quantity=2,Type="Veg" ,Pic="/images/Pizza2.JPG"}
        };
        [HttpGet]
